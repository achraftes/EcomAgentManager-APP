...
<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        <h3 class="text-2xl font-semibold leading-tight">Import Leads</h3>
    </div>
    <div class="mt-6">
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="bg-gray-100 px-4 py-3 border-b">
                <h5 class="font-bold">Import Leads from Excel</h5>
            </div>
            <div class="p-4">
                <form action="{{ route('leads.import') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    ...
                    <div class="form-group">
                        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-lg shadow-lg hover:bg-blue-600 transition duration-300">Import Leads</button>
                    </div>
                </form>
            </div>
        </div>
