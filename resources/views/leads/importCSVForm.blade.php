...
<div class="container mx-auto px-4 sm:px-8">
    <div class="py-8">
        <h3 class="text-2xl font-semibold leading-tight text-white">Import Leads from CSV</h3>
    </div>
    <div class="mt-6">
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            ...
            <div class="p-4">
                ...
                <div class="form-group">
                    <label for="inputFile" class="block text-sm font-medium text-gray-700">Upload CSV File</label>
                    <input type="file" class="mt-1 block w-full text-sm text-gray-500 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="media_buyer_id" name="media_buyer_id" required>
                </div>
                <select class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500">
                    <option value="" disabled selected>Select Media Buyer</option>
