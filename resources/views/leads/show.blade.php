            ...
            <div class="form-group">
                ...
                <table id="products-table" class="min-w-full divide-y divide-gray-200 table-fixed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="px-4 py-2">
                                <select class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="products[{{ $index }}][produit]" disabled>
                            ...
                            <td class="px-4 py-2">
                                <input type="number" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="products[{{ $index }}][prix]" value="{{ $upsale->prix }}" readonly>
                            </td>
                            <td class="px-4 py-2">
                                <input type="number" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" name="products[{{ $index }}][quantite]" value="{{ $upsale->quantite }}" readonly>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
